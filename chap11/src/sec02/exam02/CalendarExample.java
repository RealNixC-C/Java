...
//		Calendar now = new Calendar(); // 추상 클래스이기 때문에 new 연산자로 직접 객체 생성 불가
...
//		String strAm = hour24;
		...
		System.out.println(hour12 + "시 " + minute2 + "분 " + second2 + "초 ");
		System.out.println("=====================");
		...
		} else if (today.isBefore(targetDate)) { // 지정한 날짜/시간보다 이후인지
		...
		LocalDateTime deadLine = LocalDateTime.of(2025, 5, 29, 18, 0); // 2025년 5월 29일 18시
		...
		// 시간 차이
		LocalTime start = LocalTime.of(10, 0, 0); // 10시 10분 0초
