...
public class PromotionExample {
	...
	public static void main(String[] args) {
		byte byteValue = 10;
		int intValue = byteValue; // 1 byte -> 4byte, 자동 형변환
		...
		byte byteVal = 65;
//		char CharVal = byteVal; // error = Type mismatch: cannot convert from byte to char
		// byteVal; // char는 음수를 포함하지 않는데 byte 타입은 음수를 포함
