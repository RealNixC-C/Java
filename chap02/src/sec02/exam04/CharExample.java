...
public class CharExample {
	...
	public static void main (String[] args) {
		...
		char c1 = 'A'; // 실제로는 유니코드 값인 65가 메모리에 저장
...
//		char c = -65; // 음수값 저장 안됨, 유니코드는 0부터 시작
		...
		// (참고) char 타입의 산술 연산
		char var1 = 'A' + 1; // char도 결국 정수이기 때문에 산술연산이 가능
...
//		char var3 = var2 + 1; // char변수 var2가 산술 연산에 쓰이면 int로 먼저 변환됨
		 ...
		 * 2) 빈(empty) 문자 처리에 대해
		 * */
//		char c = ''; // 컴파일 에러 빈문자 자체가 유니코드에 없음
		char c = ' '; // 공백 문자(유니코드: 32) 존매하므로 가능
