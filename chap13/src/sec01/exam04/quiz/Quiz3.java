...
//	- 축구공: 3000원
	...
	public static void main(String[] args) {
		...
		Set<Equipment> copy1 = new HashSet<>();
		copy1.addAll(storage1);
		Set<Equipment> copy2 = new HashSet<>();
		copy2.addAll(storage1);
		Set<Equipment> copy3 = new HashSet<>();
		copy3.addAll(storage1);
		
		System.out.println("*** 합집합 ***");
		copy1.addAll(storage2);
		Iterator<Equipment> iterator1 = copy1.iterator();
		...
		copy2.retainAll(storage2);
		Iterator<Equipment> iterator2 = copy2.iterator();
		...
		copy3.removeAll(storage2);
		Iterator<Equipment> iterator3 = copy3.iterator();
